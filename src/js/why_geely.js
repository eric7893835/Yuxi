$(function() {
	...
	var $whyGeely = $("#whyGeely"),
		...
		viewportHeight = $(window).height() - 38,
	...
	function viewportGo(target) {
		...
		if (target == VIEWPORT_LEN) {
			...
			$whyGeely.stop().animate({"scrollTop": "+=230"},  1500, 'easeInOutExpo', function() {
...
$(function() {
	...
	$(".history-view .tab-cont").each(function() {
		...
		$prev.on("click",function() {
			...
			canClick = false;
			var n = parseInt($cur.html());
			if(parseInt($cur.html()) > 1){
				$cur.html(n - 1);
			}
